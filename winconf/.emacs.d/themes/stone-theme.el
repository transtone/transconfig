...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; ;; Highlighting faces
   `(fringe ((,class (:foreground ,base00 :background ,base02 ))))
   ...
   ;; Mode line faces
   `(mode-line ((,class (:box (:line-width 1 :color ,base00) :foreground ,base00 :background ,base02))))
   ...
   `(linum ((,class (:foreground ,base00 :background ,base02 :box (:line-width 2 :color ,base02)))))
