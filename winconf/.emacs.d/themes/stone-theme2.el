;;; stone-theme2.el --- Awesome Emacs color theme on white background
...
(let ((class '((class color) (min-colors 89)))
      ...
      (region '(:background "#babdb6")) ; #f5f5f5 or #d3d7cf or #3B3B3F
      (shadow '(:foreground "#7F7F7F"))
      (string '(:foreground "#14892C")) ; #4e9a06 or #8FB171 or #036A07 or #D0372D or #23238E or #20590C
  ...
  (custom-theme-set-faces
   'stone
   `(default ((,class (:foreground "#1a1a1a" :background "#FFFFFF"))))
   ...
   ;; ;; Highlighting faces
   `(fringe ((,class (:foreground "#F7A421" :background "#eeeeec"))))
   ...
   ;; Mode line faces
   `(mode-line ((,class (:box (:line-width 1 :color "#1A2F54") :foreground "#ffffff" :background "#3F3B3B"))))
   ...
   `(font-lock-comment-delimiter-face ((,class (:foreground "#707070")))) ; #696969
   `(font-lock-comment-face ((,class (:slant italic :foreground "#707070")))) ; #696969 or #729fcf
   `(font-lock-constant-face ((,class (:foreground "#c4a000" :weight bold))))
   `(font-lock-doc-face ((,class (:foreground "#c17d11"))))
   `(font-lock-doc-string-face ((,class (:foreground "#14892C")))) ; #75507b
   ...
   `(font-lock-type-face ((,class (:weight bold :foreground "#14892C")))) ;#5c3566
   ...
   ;; `(header-line ((,class (:weight bold :underline "black" :overline "black" :foreground "black" :background "#FFFF88"))))  #此项启用会引起tabbar样式改变
   ...
   `(nxml-attribute-local-name-face ((,class (:foreground "#D04437"))))
   `(nxml-attribute-value-delimiter-face ((,class (:foreground "#14892C"))))
   `(nxml-attribute-value-face ((,class (:foreground "#14892C"))))
