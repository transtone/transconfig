...
;; 载入package
(require 'package)
(setq package-archives '(("gnu" . "http://elpa.gnu.org/packages/") ("marmalade" . "http://marmalade-repo.org/packages/") ("melpa-stable" . "http://stable.melpa.org/packages/") ("melpa" . "http://melpa.org/packages/")))
(package-initialize)
...
Return a list of one element based on major mode."
  (list
   (cond
    ...
    ((memq major-mode
       '(jinja2-mode html-mode web-mode jsx-mode nxml-mode sgml-mode python-mode css-mode javascript-mode coffee-mode js-mode js2-mode))
     "Webcodes"
     )
    ((memq major-mode
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tss typescript typescript-mode helm-ag xahk-mode go-dlv tabbar-ruler rainbow-blocks highlight-parentheses 0blayout powerline-evil powerline tabbar solarized-theme github-theme helm-swoop evil-anzu ggtags helm-projectile projectile hydra base16-theme redo+ anzu chinese-fonts-setup zlc js-doc gtags ace-window ace-jump-helm-line helm-go-package helm-gtags helm-fuzzy-find helm-company ace-jump-mode evil-matchit evil-leader helm-c-yasnippet helm-themes helm rainbow-identifiers rainbow-mode diminish rainbow-delimiters company-web dash-functional sublimity nssh sublime-themes monokai-theme go-eldoc mustache go-snippets company-go company markdown-mode web-beautify portage-navi nginx-mode minimap neotree react-snippets jsx-mode dropdown-list fuzzy yasnippet browse-kill-ring+ smartparens hungry-delete octopress magit git-commit fold-dwim smex web-mode dirtree go-mode nlinum hideshowvis evil emacs-eclim)))
