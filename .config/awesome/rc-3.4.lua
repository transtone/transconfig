...
wicked.register(memwidget, wicked.widgets.mem, ' <span color="blue" >Memory:</span><span color="white" >$1%</span>')


-- {{{ -- CPU widget
cpuwidget = widget({ type = 'textbox', name = 'cpuwidget', align = 'right' })
--cpuwidget.width = 40
wicked.register(cpuwidget, wicked.widgets.cpu, ' <span color="blue" >cpu:</span><span color="white" >$1%</span>')
-- }}}
