...
(global-set-key [f2] 'rainbow-mode)       ; 语法高亮
...
;; (setq fcitx-active-evil-states nil)
...
(set-face-attribute
 ;; 'default nil :font "PT Mono 11")
 'default nil :font "Fira Code 13")
;; (set-face-attribute
...
(dolist (charset '(kana han symbol cjk-misc bopomofo))
  (set-fontset-font (frame-parameter nil 'font)
    charset
    ;; (font-spec :family "思源黑体 medium" :size 12 )))
    ;; (font-spec :family "苹方-简" :size 12 )))
